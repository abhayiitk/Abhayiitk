classdef CovidDataOfCountry < Datavalues
    ...
    methods
        function obj = CovidDataOfCountry(covid_data, nameOfCountry, indexOfCountryIncludingGlobal)
            obj@Datavalues(covid_data, indexOfCountryIncludingGlobal);
            ...
            if isequal(obj.CountOfCountry, 1)              
                ...
                for ii = 1 : obj.NumberOfStates
                    ...
                    obj.ListOfStates{ii} = CovidDataOfState(covid_data, nameOfState, indexOfState);
